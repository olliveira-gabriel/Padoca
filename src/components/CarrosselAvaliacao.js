      ...
      <Carousel indicators={false}>
        <Carousel.Item>
          <Container>
            <Row className="justify-content-center">
              ...
              <Col md={5}>
                <AvaliacaoCard nome="Jefferson" texto="Melhor pão de queijo que já comi!" />
              </Col>
            </Row>
          </Container>
        </Carousel.Item>
        ...
        <Carousel.Item>
          <Container>
            <Row className="justify-content-center">
              <Col md={5}>
                <AvaliacaoCard nome="Maria" texto="Amei a padaria! Atendimento maravilhoso!" />
              </Col>
              <Col md={5}>
                <AvaliacaoCard nome="Lucas" texto="Melhor pão de queijo que já comi!" />
              </Col>
            </Row>
          </Container>
        </Carousel.Item>
